...
//
// Color is a literal hex, not var(--md-sys-color-accent-red): this renders to a
...
// paint anything. This hex value must match --md-sys-color-accent-red in material3-theme.css.
const LOBSTER_RED = '#E83F3F'; // M3 accent-red token value
